export default {
  byId: {
    8: {
      ...
      name: "Ring of Arouse",
      description:
        "Doesn't matter if you are looking to spice things up with your couple or compensating for the secondary effects on Furtiva Lagrima. Ring of Arouse ensures an everlasting life of wildness with your loved one! Just remember, once the ring is put on, it can't be removed. Approved by Beyoncé.",
    ...
    0: {
      ...
      fate: {
        solo:
          "After your death no one will ever remove your dog's collar, so it will roam the world looking for you until the sun engulfs Earth, damaging the collar enough to fall.",
        normal:
          "After your death no one will ever remove your dog's collar, so it will roam the world looking for you until the sun engulfs Earth, damaging the collar enough to fall."
      }
    },
    1: {
      ...
      fate: {
        solo:
          "After your death no one will ever remove your cat's collar, so it will roam the world sleeping on trees and not giving a fuck about anything until the sun engulfs Earth, damaging the collar enough to fall.",
        normal:
          "After your death no one will ever remove your cat's collar, so it will roam the world sleeping on trees and not giving a fuck about anything until the sun engulfs Earth, damaging the collar enough to fall."
      }
    },
    2: {
      ...
      name: "Regrowth Tonic",
      description:
        "Yes you bald son of a gun! You can get your hair back with this awesome tonic, the same shit you tried a few years ago and didn't work, well... this one actually does! Finally an answer!",
      category: "health",
    ...
    3: {
      ...
      name: "Dietapple",
      description:
        "\"Dieticians hate it\". Of course they do, after eating that apple you won't need to eat healthy ever again! Actually you could survive on eating wood, dust, glass.... you name it! The effects are permanent, and why wouldn't they? There only downside it is that you'll always be shitting spicy, minor stuff.",
      ...
      fate: {
        solo:
          "Dietapple allowed you to devour the greatest pizzas, the fattest burritos and unhealthy amounts of chocolate, the problem was the other part. And why wouldn't? Shitting became a nightmare, fear took control of your body as soon as you felt nature's call. It wasn't spicy poop, it was fire, lava, true hell. You died after a midnight dump started a fire that burned the whole neighborhood.",
        normal:
          "Dietapple allowed you to devour the greatest pizzas, the fattest burritos and unhealthy amounts of chocolate, the problem was the other part. And why wouldn't? Shitting became a nightmare, fear took control of your body as soon as you felt nature's call. It wasn't spicy poop, it was fire, lava, true hell.",
        end:
          "You died after a midnight dump started a fire that burned the whole neighborhood."
      }
    },
    4: {
      id: 4,
      ...
      description:
        "One of our best sellers, the classical Love Potion. If your heart only has room for one person and that person doesn't even want to hear your name, worry no more! Make sure your loved one drinks all of it and all your love problems will be solved... except for one thing, Furtiva Lagrima does have a negative effect on sexual desire, but hey! HEY! We've got a solution for that too!",
      ...
      fate: {
        solo:
          "Since the day you spilled that tiny flask on your loved one, she never left your side. People never understood why would someone be attracted to you but they never asked, at least it seemed something intellectual as she keeps her distance most of the time. A few years later that distance made you break the relationship, which finally lead her to kill herself. After some years being chased by guilt you joined her in a shakespearean fashion.",
        normal:
          "Since the day you spilled Furtiva Lagrima on your loved one, she never left your side. It became something obsessive for her, irrational to the point that you couldn't take it anymore and you broke the relationship. She ended her life out of desperation.",
        end:
          "After all, what ended with you was the guilt you felt for who had been the love of your life, driving her to suicide made you join her short after in a shakespearean fashion."
      }
    },
    5: {
      id: 5,
      name: "Powers' Mojo",
      description:
        "Have trouble meeting baes? Always felt like Awsin Powers shouldn't have got his mojo back because you are the one who should have it? Do you want to be the synonym for sex, drugs and Rock n' Roll? well stop asking questions, look no further!",
      ...
      fate: {
        solo:
          "Your greediness for sex, attention and ego led you to purchase Power's Mojo. It proved to be a bad choice since the moment you injected that shit, you became irrationally attractive for both male and female, animal and human, the nightmare stretched day and night. The line was crossed when your parents offered you a ménage à trois during a family dinner... You ended up leaving everything and everyone to go live on a desert island. The irony of the situation was finally what killed you, yes, death by irony.",
        normal:
          "Power's Mojo proved to be a bad choice since the moment you injected that shit, you became unreasonably attractive for both male and female, animal and human, the nightmare stretched day and night. The line was crossed when your parents offered you a ménage à trois during a family dinner... ",
        end:
          "What ended your life was Powers' Mojo's effect, sick of it you ended up leaving everything and everyone to go live on a desert island. The irony of the situation was finally what killed you, yes, death by irony."
      }
    },
    6: {
      id: 6,
      name: "Coffee mug",
      description:
        "Looks like a regular mug, but the last half is always full of hot freshly made coffee, doesn't seem like a good idea? Think again. Disclaimer: If staying awake is what you're after we sell that too, look for Owl Droplets. This cup is for coffee lovers only!",
      ...
      fate: {
        solo:
          "One day your life took a turn for the best, you acquired a magical coffee mug that simply made everyday a better day. Somehow that had a positive effect on your attitude that made life much much easier. And you probably got married, had kids, wealth and a good health I don't know, I don't care either, this was simply a good choice, the choice of the winners. You are a winner, praise the coffee and stuff...",
        normal:
          "But even when your life was going to hell you could always come back to that excellent coffee mug and relax for a few seconds. The only good choice you made that day on Luci's Little Trinkets",
        end:
          "The last days of your existence were so wrong that you turned to your coffee addiction, the coffee that mug made was so great that you felt like nothing mattered anymore. Then decided to end your life drawing yourself in a bathtub of coffee."
      }
    },
    7: {
      id: 7,
      name: "Owl droplets",
      description:
        "Well you'll be missing on one of the greatest pleasures there is, but now you'll be able to spend that time in something of your choice, like sleeping...",
      ...
      fate: {
        solo:
          "Only getting some extra time felt like a good idea at the beginning, but as time went on you realized you would prefer to use that extra time in something else, so you soon came back to Luci's Little Trinkets for more. What started as a safe reasonable choice, ended with the purchase of almost every item on the shop, killing you short after the check out, nevermind the age that the counter shows you right now!. How about that you greedy bastard, rejoice!",
        normal:
          "Owl Droplets gave you more time on your daily basis, allowing you to catch up on all those Netflix shows everyone was watching, playing all games you didn't have time to play, and finishing personal projects. After a few weeks you realized you weren't keeping any memories of your day, your brain couldn't retain anymore and although you could try to sleep to fix what was wrong, you never could do more than lay waiting."
      }
    },
    9: {
      id: 9,
